...
const navItems = [
  ...
  { label: "Business Units", to: "/platform/business-units", end: false },
  { label: "Reports", to: "/platform/reports", end: false },
  { label: "Settings Workspace", to: "/platform/settings", end: false },
] as const;
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-slate-900 bg-gradient-to-b from-slate-950 to-slate-900 text-slate-100 transition-all duration-300">
      <div className="border-b border-slate-900 px-5 py-6">
        ...
        <span className="mt-1.5 inline-block rounded bg-indigo-500/10 border border-indigo-500/20 px-2 py-0.5 text-[9px] font-bold text-indigo-400 uppercase tracking-wider">Sonata Governance</span>
      </div>
