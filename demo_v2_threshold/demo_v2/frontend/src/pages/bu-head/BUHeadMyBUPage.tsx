/**
 * BU Head -- My Business Unit view.
 * Auto-loads the BU(s) assigned to the logged-in BU Head via the API
 * (backend filters business-units by bu_head_user_id for BU_HEAD role).
 */
...
export function BUHeadMyBUPage() {
  ...
  if (bus.length === 0) return (
    <div className="rounded-xl border border-dashed border-slate-300 p-12 text-center">
      ...
      <p className="text-xs text-slate-400 mt-1">Contact your Platform Admin to assign you as BU Head.</p>
    </div>
  );
