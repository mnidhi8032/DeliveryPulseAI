...
class Notification(Base, TimestampMixin):
    ...
    submission: Mapped["Submission | None"] = relationship("Submission", foreign_keys=[related_submission_id])
    project: Mapped["Project | None"] = relationship("Project", foreign_keys=[related_project_id])
